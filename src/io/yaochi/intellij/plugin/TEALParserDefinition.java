...
public class TEALParserDefinition implements ParserDefinition {
	...
	public static final TokenSet CONSTANTS = TokenSet.create(
			...
			AMOUNT, CLOSEREMAINDERTO, VOTEPK, SELECTIONPK, SELECTIONPK, VOTEFIRST, VOTELAST, VOTEKEYDILUTION,
			TYPE, TYPEENUM, XFERASSET, ASSETAMOUNT, ASSETSENDER, ASSETRECEIVER, ASSETCLOSETO, GROUPINDEX,
			TXID, MINTXNFEE, MAXTXNLIFE, ZEROADDRESS, GROUPSIZE);
